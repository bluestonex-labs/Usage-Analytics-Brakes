		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bsxusageanalytics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bsxusageanalytics-display": {
								"semanticObject": "bsxusageanalytics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bsx.usageanalytics",
									"url": sap.ui.require.toUrl("bsx/usageanalytics")
								}
							}
						}
					}
